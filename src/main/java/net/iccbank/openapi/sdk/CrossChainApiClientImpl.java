...
public class CrossChainApiClientImpl extends HttpClient implements CrossChainApiClient, Encryptable {
     ...
     */
    public CrossChainApiClientImpl(String appId, String appSecret, String token) {
     ...
     * @param token     报文加解密的token
     */
    public CrossChainApiClientImpl(String urlPrefix, String appId, String appSecret, String token) {
     ...
     * @param readTimeout
     */
    public CrossChainApiClientImpl(String urlPrefix, String appId, String appSecret, String token, long connectTimeout, long writeTimeout, long readTimeout) {
        if (urlPrefix == null) {
    ...
    public ApiResponse<CreateCrossChainSubscriptionOrder> createSubscriptionOrder(String thirdId, String currencyCode, String tokenCurrencyCode, String address, String labelAddress, BigDecimal amount) {
        ...
        String url = ApiConstants.concatUrl(urlPrefix, ApiConstants.CROSS_CHAIN_CREATE_SUBSCRIPTION_ORDER);
        String resBody = callToString(url, paramsMap);
        return JsonUtils.parseObject(resBody, new TypeReference<ApiResponse<CreateCrossChainSubscriptionOrder>>() {});
    }
    ...
    public ApiResponse<CreateCrossChainRedemptionOrder> createRedemptionOrder(String thirdId, String currencyCode, String tokenCurrencyCode, String address, String labelAddress, BigDecimal amount) {
        ...
        paramsMap.put("labelAddress", labelAddress);
        paramsMap.put("amount", amount);
        String url = ApiConstants.concatUrl(urlPrefix, ApiConstants.CROSS_CHAIN_CREATE_REDEMPTION_ORDER);
        String resBody = callToString(url, paramsMap);
        return JsonUtils.parseObject(resBody, new TypeReference<ApiResponse<CreateCrossChainRedemptionOrder>>() {});
    }
    ...
    public ApiResponse<CrossChainEstimateMinerFeeRedemptionOrder> estimateMinerFeeRedemptionOrder(String currencyCode, String tokenCurrencyCode, String address, String labelAddress, BigDecimal amount) {
        ...
        String resBody = callToString(url, paramsMap);
        return JsonUtils.parseObject(resBody, new TypeReference<ApiResponse<CrossChainEstimateMinerFeeRedemptionOrder>>() {});
    }
    ...
    public ApiResponse<QueryCrossChainSubscriptionOrder> querySubscriptionOrder(String orderId) {
        ...
        String url = ApiConstants.concatUrl(urlPrefix, ApiConstants.CROSS_CHAIN_QUERY_SUBSCRIPTION_ORDER);
        String resBody = callToString(url, paramsMap);
        return JsonUtils.parseObject(resBody, new TypeReference<ApiResponse<QueryCrossChainSubscriptionOrder>>() {});
    }
    ...
    public ApiResponse<QueryCrossChainRedemptionOrder> queryRedemptionOrder(String orderId) {
        ...
        TreeMap<String, Object> paramsMap = new TreeMap<String, Object>();
        paramsMap.put("orderId", orderId);
        String url = ApiConstants.concatUrl(urlPrefix, ApiConstants.CROSS_CHAIN_QUERY_REDEMPTION_ORDER);
        String resBody = callToString(url, paramsMap);
        return JsonUtils.parseObject(resBody, new TypeReference<ApiResponse<QueryCrossChainRedemptionOrder>>() {});
    }
}
